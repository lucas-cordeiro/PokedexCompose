...
fun provideHttpClient(baseUrl: String, httpSerializer: HttpSerializer, logging: LoggingInterceptor, httpTimeout: br.com.lucascordeiro.pokedex.data.network.httpclient.timeout.HttpTimeout) = object : AppHttpClient {
